...
class Item(Resource):
 #parser belongs to te class itself not the object
    ...
    def put(self,name):
        ...
        if item is None:
            try:
                ...
                return {'Mesaage': "An error occurred inserting the item"} , 500
        else:
            try:
                self.update(updated_item)
            except:
                return {'Mesaage': "An error occurred updating the item"} , 500    
        return updated_item
